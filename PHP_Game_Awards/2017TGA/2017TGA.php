...
// 2. DATA CONFIGURATION: 2017 Winners
$current_year = "2017";
...
$categories = [
    [
        ...
        "dev_logo" => "Wolfeinstaın LOGO.png",
        "dev_name" => "MachineGames",
        "score" => 87,
        "image" => "wolfenstein-2-the-new-colossus_8njs.jpg",
        "link" => "https://bethesda.net/en/game/wolfenstein-ii"
    ],
    [
        "title" => "Best Indie + Best Debut Indie + Best Art Direction",
        "winner" => "Cuphead",
        "dev_logo" => "cupheadLOGO.jpeg",
        "dev_name" => "Studio MDHR",
        "score" => 86,
        "image" => "Cuphead.webp",
    ...
    [
        ...
        "dev_logo" => "what remains logo.png",
        "dev_name" => "Giant Sparrow",
        "score" => 88,
        "image" => "whats remains .avif",
        "link" => "https://www.giantsparrow.com/games/finch/"
    ],
    [
        "title" => "Best Performance + Best Audio Design + Games for Impact",
        "winner" => "Hellblade: Senua's Sacrifice",
        "dev_logo" => "HellBlade logo.jpeg",
        "dev_name" => "Ninja Theory",
        "score" => 81,
        "image" => "Hellblade.jpeg",
        "link" => "https://www.hellblade.com/"
    ],
    [
        "title" => "Best Role Playing Game (RPG)",
        "winner" => "Persona 5",
        "dev_logo" => "persona logor.jpeg",
        "dev_name" => "Atlus",
        "score" => 95,
        "image" => "persona 5 .jpeg",
        "link" => "https://persona.atlus.com/p5/"
    ],
    [
        "title" => "Best Fighting Game",
        "winner" => "Injustice 2",
        "dev_logo" => "injusticelogo.png",
        "dev_name" => "NetherRealm Studios",
        "score" => 87,
        "image" => "injustice2.jpg",
...
<head>
    ...
    <meta name="keywords" content="The Game Awards 2017, Zelda Breath of the Wild GOTY, Persona 5, TGA Winners">
    <meta name="description" content="Official winners list of The Game Awards 2017.">
</head>
<body>
...
<div class="modal-overlay" id="loginModal">
    ...
    <div class="detail-container">
        ...
        <header style="text-align: left; margin-bottom: 40px; margin-top: 20px;">
            ...
            <p>Celebrating the greatest titles of 2017.</p> 
        </header>
