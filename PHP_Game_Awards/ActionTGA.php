...
// Oyun verilerini içeren dizi
$games = [
    ["year" => "2025", "title" => "Hades 2", "score" => 94, "img" => "AksiyonTGA/Hades2.jpg"],
    ["year" => "2024", "title" => "Black Myth Wukong", "score" => 81, "img" => "AksiyonTGA/Wukong.jpg"],
    ["year" => "2023", "title" => "Armored Core 6", "score" => 86, "img" => "AksiyonTGA/Armored Core 6.jpg"],
    ["year" => "2022", "title" => "Bayonetta 3", "score" => 86, "img" => "AksiyonTGA/Bayonetta_3.png"],
    ["year" => "2021", "title" => "Returnal", "score" => 86, "img" => "AksiyonTGA/Returnal.jpeg"],
    ["year" => "2020", "title" => "Hades", "score" => 93, "img" => "AksiyonTGA/Hades.jpg"],
    ["year" => "2019", "title" => "Devil May Cry 5", "score" => 87, "img" => "AksiyonTGA/devil my cry 5 .jpg"],
    ["year" => "2018", "title" => "Dead Cells", "score" => 89, "img" => "AksiyonTGA/DeadCells.jpg"]
];
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    <title>Aksiyon Kategorisi - TGA Arşivi</title>
    ...
    <style>
        ...
        /* CSS kodların aynen korunmuştur */
...
<nav class="category-nav">
    <div class="nav-container">
        <a href="ActionTGA.php" class="cat-item active" rel="noopener noreferrer">
            <i class="fas fa-sword"></i> AKSİYON
        </a>
        <a href="RPG_TGA.php" class="cat-item" rel="noopener noreferrer">
...
<div class="action-header">
    <h1 class="category-title">AKSİYON KATEGORİSİ</h1>
...
<div class="detail-container">
    ...
    <div class="timeline">
        ...
        <div class="event">
            <div class="event-year"><?php echo $game['year']; ?></div>
            <div class="action-card">
                <img src="<?php echo $game['img']; ?>" alt="<?php echo $game['title']; ?>">
