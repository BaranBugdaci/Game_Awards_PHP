...
$dosyaAdi = __DIR__ . "/../storage/comments/comments_{$safeKey}.txt";

// storage/comments/ klasörü yoksa oluştur
if (!file_exists(__DIR__ . "/../storage/comments")) {
    mkdir(__DIR__ . "/../storage/comments", 0755, true);
}
