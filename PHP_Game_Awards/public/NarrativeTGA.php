...
$games = [
    ...
    ["year" => "2023", "title" => "Alan Wake 2",                      "score" => 89, "img" => "2023TGA/Alan_Wake_2.jpeg"],
    ["year" => "2022", "title" => "God of War: Ragnarök",             "score" => 94, "img" => "2022TGA/Gow Ragnorök.jpg"],
    ["year" => "2021", "title" => "Marvel's Guardians of the Galaxy", "score" => 80, "img" => "2021TGA/MarvelGalaxy.jpeg"],
    ["year" => "2020", "title" => "The Last of Us Part II",           "score" => 93, "img" => "2020TGA/TLOU Part 2.jpg"],
    ["year" => "2019", "title" => "Disco Elysium",                    "score" => 89, "img" => "2019TGA/Disco Elysium.jpg"],
    ["year" => "2018", "title" => "Red Dead Redemption 2",            "score" => 97, "img" => "2018TGA/RDR2.jpg"],
];
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    <title>Hikaye Kategorisi - TGA Arşivi</title>
...
<nav class="category-nav">
    <div class="nav-container">
        ...
        <a href="NarrativeTGA.php" class="cat-item active" rel="noopener noreferrer"><i class="fas fa-trophy"></i> HİKAYE</a>
    </div>
</nav>

<div class="action-header">
    <h1 class="category-title">EN İYİ HİKAYE KATEGORİSİ</h1>
