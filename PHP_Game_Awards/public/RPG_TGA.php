...
// RPG oyunu verilerini içeren dizi
$games = [
    ["year" => "2025", "title" => "Expedition 33",          "score" => 92, "img" => "2025TGA/Expediton0.jpg"],
    ["year" => "2024", "title" => "Metaphor: ReFantazio",   "score" => 94, "img" => "2024TGA/Metaphor.jpg"],
    ["year" => "2023", "title" => "Baldur's Gate 3",        "score" => 96, "img" => "2023TGA/Baldur’s Gate 3.jpeg"],
    ["year" => "2022", "title" => "Elden Ring",             "score" => 96, "img" => "2022TGA/Elden_Ring.jpg"],
    ["year" => "2021", "title" => "Tales of Arise",         "score" => 87, "img" => "2021TGA/tales of arise.jpg"],
    ["year" => "2020", "title" => "Final Fantasy 7 Remake", "score" => 87, "img" => "2020TGA/FF7.jpg"],
    ["year" => "2019", "title" => "Disco Elysium",          "score" => 89, "img" => "2019TGA/Disco Elysium.jpg"],
    ["year" => "2018", "title" => "Monster Hunter: World",  "score" => 90, "img" => "2018TGA/monster-hunter-world.avif"],
];
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    <title>RPG Kategorisi - TGA Arşivi</title>
    ...
    <style>
        ...
        .action-header {
            ...
            background: linear-gradient(to bottom, rgba(139, 0, 0, 0.25), transparent);
            margin-top: -20px;
        }
        ...
        /* Kategori Menüsü — fixed navigasyon */
        .category-nav {
            width: 100%;
            padding: 20px 0;
        ...
        /* Aktif olan veya seçilen kategori için parlama efekti */
        .cat-item.active {
            color: #000 !important;
        ...
        /* Global CSS'den gelen yanlış aktif stilini sıfırla */
        .cat-item:not(.active) {
            background: rgba(0, 0, 0, 0.2) !important;
            color: rgba(197, 160, 89, 0.7) !important;
            -webkit-text-fill-color: rgba(197, 160, 89, 0.7) !important;
...
<div class="modal-overlay" id="loginModal">
    ...
    <nav class="category-nav">
        <div class="nav-container">
            <a href="ActionTGA.php" class="cat-item" rel="noopener noreferrer">
                <i class="fas fa-sword"></i> AKSİYON
            </a>
            <a href="RPG_TGA.php" class="cat-item active" rel="noopener noreferrer">
                <i class="fas fa-magic"></i> RPG
            </a>
            <a href="IndieTGA.php" class="cat-item" rel="noopener noreferrer">
                <i class="fas fa-rocket"></i> INDIE
            </a>
            <a href=FightingTGA.php" class="cat-item" rel="noopener noreferrer">
                <i class="fas fa-chess"></i> DÖVÜŞ
            </a>
            <a href="NarrativeTGA.php" class="cat-item" rel="noopener noreferrer">
                <i class="fas fa-trophy"></i> HİKAYE
            </a>
        </div>
    </nav>

    <div class="action-header">
        <h1 class="category-title">ROL YAPMA (RPG) KATEGORİSİ</h1>
        ...
        <div class="timeline">
            ...
            <div class="event">
                ...
                <div class="action-card">
                    <img src="<?php echo htmlspecialchars($game['img']); ?>"
