...
$games = [
    ["year" => "2025", "title" => "Fatal Fury City of The Wolves", "score" => 80, "img" => "2025TGA/Fatal_Fury_City_of_the_Wolves.jpg"],
    ["year" => "2024", "title" => "Tekken 8",                      "score" => 90, "img" => "2024TGA/Tekken8.jpeg"],
    ["year" => "2023", "title" => "Street Fighter 6",              "score" => 92, "img" => "2023TGA/Street Fighter 6.jpeg"],
    ["year" => "2022", "title" => "Multi Versus",                  "score" => 75, "img" => "2022TGA/Multiversus.jpeg"],
    ["year" => "2021", "title" => "Guilty Gear Strive",            "score" => 75, "img" => "2021TGA/guilty-gear-strive.jpg"],
    ["year" => "2020", "title" => "Mortal Kombat 11 Ultimate",     "score" => 88, "img" => "2020TGA/MK11Ultimate.jpg"],
    ["year" => "2019", "title" => "Super Smash Bros. Ultimate",    "score" => 93, "img" => "2019TGA/SSB Ultimate.png"],
    ["year" => "2018", "title" => "Dragon Ball FighterZ",          "score" => 87, "img" => "2018TGA/dragonball.jpeg"],
];
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <meta charset="UTF-8">
    <title>Dövüş Kategorisi - TGA Arşivi</title>
...
<nav class="category-nav">
    <div class="nav-container">
        ...
        <a href="IndieTGA.php"     class="cat-item"        rel="noopener noreferrer"><i class="fas fa-rocket"></i> INDIE</a>
        <a href="FightingTGA.php"  class="cat-item active" rel="noopener noreferrer"><i class="fas fa-chess"></i>  DÖVÜŞ</a>
        <a href="NarrativeTGA.php" class="cat-item"        rel="noopener noreferrer"><i class="fas fa-trophy"></i> HİKAYE</a>
    </div>
</nav>

<div class="action-header">
    <h1 class="category-title">DÖVÜŞ OYUNLARI KATEGORİSİ</h1>
