...
require "../includes/auth_nav.php"; 

// 1. DİNAMİK VERİ LİSTESİ
$tga_arsiv = [
    ["yil" => "2025", "link" => "/2025TGA/2025TGA.php"],
    ["yil" => "2024", "link" => "/2024TGA/2024TGA.php"],
    ["yil" => "2023", "link" => "/2023TGA/2023TGA.php"],
    ["yil" => "2022", "link" => "/2022TGA/2022TGA.php"],
    ["yil" => "2021", "link" => "/2021TGA/2021TGA.php"],
    ["yil" => "2020", "link" => "/2020TGA/2020TGA.php"],
    ["yil" => "2019", "link" => "/2019TGA/2019TGA.php"],
    ["yil" => "2018", "link" => "/2018TGA/2018TGA.php"],
    ["yil" => "2017", "link" => "/2017TGA/2017TGA.php"]
];
...
<body>
    ...
    <div class="modal-overlay" id="loginModal">
        <div class="modal-box">
            ...
            <form method="POST" action="">
                ...
                <button type="submit" name="login_submit">OTURUM AÇ</button>
            </form>

            <div class="modal-footer">
                Hesabınız yok mu? <a href="/Register.php" rel="noopener noreferrer">Hemen Kayıt Olun</a>
            </div>
        </div>
    </div>
    ...
    <nav class="category-nav">
        <div class="nav-container">
            <a href="/ActionTGA.php" rel="noopener noreferrer" class="cat-item">
