...
// 2. DATA CONFIGURATION: 2018 Winners
$current_year = "2018";
...
$goty = [
    ...
    "score" => 94,
    "image" => "Gow.webp",
    "video" => "God of War – Story Trailer _ PS4.mp4",
    "link" => "https://sms.playstation.com/",
    "extra_awards" => [
...
$categories = [
    [
        "title" => "Best Ongoing Game + Best Multiplayer Game",
        "winner" => "Fortnite",
    ...
    [
        "title" => "Best Independent Game + Games for Impact",
        "winner" => "Celeste",
        "dev_logo" => "Celestelogo.png",
        "dev_name" => "Maddy Makes Games",
        "score" => 92,
        "image" => "Celeste.jpeg",
    ...
    [
        ...
        "dev_logo" => "Return of obra dinn LOGO.png",
        "dev_name" => "3909 LLC",
        "score" => 89,
        "image" => "Return-of-the-Obra-Dinn-Title.webp",
        "link" => "https://obradinn.com/"
    ],
    [
        "title" => "Best Action Game",
        "winner" => "Dead Cells",
        "dev_logo" => "deadcells LOGO.png",
        "dev_name" => "Motion Twin",
        "score" => 89,
        "image" => "DeadCells.jpg",
    ...
    [
        ...
        "dev_logo" => "monster LOGO.png",
        "dev_name" => "Capcom",
        "score" => 90,
        "image" => "monster-hunter-world.avif",
        "link" => "https://www.monsterhunter.com/world/"
    ],
    [
        "title" => "Best Fighting Game",
        "winner" => "DRAGON BALL FighterZ",
        "dev_logo" => "dragonball logo.png",
        "dev_name" => "Arc System Works",
        "score" => 87,
        "image" => "dragonball.jpeg",
        "link" => "https://www.bandainamcoent.com/games/dragon-ball-fighterz"
    ],
    [
        "title" => "Best Strategy Game",
        "winner" => "Into The Breach",
        "dev_logo" => "İnto the breach LOGO.jpeg",
        "dev_name" => "Subset Games",
        "score" => 90,
        "image" => "into teh breach.jpeg",
        "link" => "https://subsetgames.com/itb.html"
    ],
    [
        "title" => "Best Mobile Game",
        "winner" => "Florence",
        "dev_logo" => "FlorenceLOGO.png",
        "dev_name" => "Mountains Studio",
        "score" => 82,
        "image" => "Florence.webp",
        "link" => "http://mountains.studio/"
    ],
    [
        "title" => "Best Narrative + Performance + Music + Audio Design",
        "winner" => "Red Dead Redemption 2",
        "dev_logo" => "Rockstar.png",
        "dev_name" => "Rockstar Games",
        "score" => 97,
        "image" => "RDR2.jpg",
...
<head>
    ...
    <meta name="keywords" content="The Game Awards 2018, God of War GOTY, Red Dead Redemption 2, TGA Winners">
    <meta name="description" content="Official winners list of The Game Awards 2018.">
</head>
<body>
...
<div class="modal-overlay" id="loginModal">
    ...
    <div class="detail-container">
        ...
        <header style="text-align: left; margin-bottom: 40px; margin-top: 20px;">
            ...
            <p>Showcasing the peak of gaming excellence from 2018.</p> 
        </header>
        ...
        <section style="margin-bottom: 50px;">
            ...
            <div class="media-row">
                <img src="<?php echo $goty['image']; ?>" class="game-main-img" alt="Main Game Visual">
                ...
                <div class="category-item" onclick="toggleCategory(this)">
                    ...
                    <div class="category-panel">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                            <div class="dev-section">
                                <img src="<?php echo $cat['dev_logo']; ?>" class="dev-logo" alt="dev logo">
